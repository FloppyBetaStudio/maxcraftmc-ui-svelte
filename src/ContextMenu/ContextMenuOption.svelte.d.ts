...
export type ContextMenuOptionProps<Icon = any> = Omit<
  $RestProps,
  keyof $Props<Icon>
> &
  $Props<Icon>;

export default class ContextMenuOption<Icon = any> extends SvelteComponentTyped<
  ContextMenuOptionProps<Icon>,
  {
