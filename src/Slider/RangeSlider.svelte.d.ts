...
export interface RangeSliderChangeDetail {
  value: number;
  valueUpper: number;
}

export type ActiveHandle = "lower" | "upper";
...
export type RangeSliderProps = Omit<$RestProps, keyof $Props> & $Props;

export default class RangeSlider extends SvelteComponentTyped<
  RangeSliderProps,
  {
    change: CustomEvent<{ value: number; valueUpper: number }>;
    click: WindowEventMap["click"];
    input: CustomEvent<{ value: number; valueUpper: number }>;
